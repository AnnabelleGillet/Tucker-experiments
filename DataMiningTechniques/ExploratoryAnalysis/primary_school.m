...
function [plt] = plot_time(time_factor_matrix)
    ...
    for i = 1:nb
        ...
        xline(datetime(0,0,0,12,0,0), '--r', {'Lunch', 'Break'}, 'FontSize', fontsize - 5, 'LineWidth', 2)
        xline(datetime(0,0,0,14,0,0), '--r', 'LineWidth', 2)
        xline(datetime(0,0,0,10,0,0), '--r', {'Morning', 'Break'}, 'FontSize', fontsize - 5, 'LineWidth', 2)
        xline(datetime(0,0,0,11,0,0), '--r', 'LineWidth', 2)
        xline(datetime(0,0,0,15,15,0), '--r', {'Afternoon', 'Break'}, 'FontSize', fontsize - 5, 'LineWidth', 2)
        xline(datetime(0,0,0,16,15,0), '--r', 'LineWidth', 2)

        nexttile
        plot(t, day2, 'LineWidth', 2);
        if (i == 1)
